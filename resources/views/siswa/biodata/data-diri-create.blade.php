...
@section('page-title', 'Isi Biodata-Diri')
  
@section('content')
<div class="row">
  <div class="card col-md-6 col-lg-6 col-sm-12">
    <div class="card-body">
      <form action="{{ route('biodata-diri.store') }}" method="POST">
        @csrf
        {{-- unit --}}
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="nama_lengkap" placeholder="budi santoso" required>
        </div>

        {{-- nama panggilan --}}
        <div class="mb-3">
          <label class="form-label">Nama Lengkap<small class="text-danger"><i>* wajib di isi</i></small></label>
          <input type="text" class="form-control" name="nama_panggilan" placeholder="budi" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="no_wali" placeholder="082346571348">
        </div>

        {{-- nisn --}}
        <div class="mb-3">
          <label class="form-label">NISN<small class="text-danger"><i>* wajib di isi</i></small></label>
          <input type="text" class="form-control" name="nisn" placeholder="0129831278" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="anak_ke" placeholder="2" required>
        </div>
        
        {{-- jumlah saudara --}}
        <div class="mb-3">
          <label class="form-label">Jumlah Saudara<small class="text-danger"><i>* wajib di isi</i></small></label>
          <input type="text" class="form-control" name="jumlah_saudara" placeholder="5" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" name="alamat_lengkap" rows="6" placeholder="Content.."></textarea>
        </div>

        {{-- berat badan --}}
        <div class="mb-3">
          <label class="form-label">Berat Badan<small class="text-danger"><i>* wajib di isi</i></small></label>
          <input type="text" class="form-control" name="berat_badan" placeholder="50 kg" required>
        </div>

        {{-- tinggi badan --}}
        <div class="mb-3">
          <label class="form-label">Tinggi Badan<small class="text-danger"><i>* wajib di isi</i></small></label>
          <input type="text" class="form-control" name="tinggi_badan" placeholder="150 cm" required>
        </div>

        {{-- tinggi badan --}}
        <div class="mb-3">
          <label class="form-label">Golongan Darah</label>
          <input type="text" class="form-control" name="gol_darah" placeholder="Am">
        </div>

        {{-- riwayat sakit --}}
        <div class="mb-3">
          <label class="form-label">Riwayat Sakit</label>
          <textarea class="form-control" name="riwayat_sakit" rows="6" placeholder="Content.."></textarea>
        </div>

        {{-- tinggi badan --}}
        <div class="mb-3">
          <label class="form-label">Asal Sekolah<small class="text-danger"><i>* wajib di isi</i></small></label>
          <input type="text" class="form-control" name="asal_sekolah" placeholder="Am" required>
        </div>

        {{-- alamat sekolah --}}
        <div class="mb-3">
          <label class="form-label">Alamat Sekolah<small class="text-danger"><i>* wajib di isi</i></small></label>
          <textarea class="form-control" name="alamat_sekolah" rows="6" placeholder="Content.."></textarea>
        </div>
