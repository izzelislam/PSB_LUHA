...
@section('page-title', 'Edit Biodata-Ibu')
  
@section('content')
<div class="row">
  <div class="card col-md-6 col-lg-6 col-sm-12">
    <div class="card-body">
      <form action="{{ route('ibu.update', $ayah->id) }}" method="POST">
        @csrf
        @method('PUT')
        {{-- agama --}}
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" name="penghasilan" value="{{ $ayah->pendapatan }}" placeholder="Wirausaha" required>
        </div>
